...
import Header from from '..//FiltersGroup'
  ...
  getJobs = async () => {
    ...
    if (response.ok === true) {
      ...
      const updatedJobsData = data.jobs.map(eachJob =>({
        ...
        packagePeraAnnum: eachJob.package_per_annum,
      ...
      <div className="all-jobs-container">
       ...
       <div className="no-jobs-view">
          ...
          <p className="no-jobs-description">
            We cloud not find any jobs. Try other filters.
          </p>
       </div>
    )
  }
